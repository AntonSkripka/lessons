...
const getUsersWithEyeColor = (users, color) => {
    //! твій код
    let usersWithEyeColor = users.filter((item) => item.eyeColor === color);
...
const getUsersWithGender = (users, gender) => {
    //! твій код
    let usersGender = users.filter((item) => item.gender === gender).map((item) => item.name);
    return usersGender;
};
...
const getInactiveUsers = users => {
    //! твій код
    let usersActive = users.filter((item) => !item.isActive);
    return usersActive;
};
...
const getUserWithEmail = (users, email) => {
    //! твій код
    let userWithEmail = users.find((item) => item.email === email);
